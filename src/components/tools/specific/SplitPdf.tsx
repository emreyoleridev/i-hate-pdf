    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center py-20 px-4 relative min-h-[80vh] w-full">
            ...
            <div className="relative z-10 w-full text-center flex flex-col items-center max-w-4xl mx-auto">
                ...
                {status === "options" && file && (
                    <div className="w-full max-w-2xl p-10 rounded-3xl border border-zinc-200 dark:border-zinc-700 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm shadow-2xl">
                        <div className="flex items-center justify-between mb-8 pb-6 border-b border-zinc-200 dark:border-zinc-700">
                        ...
                        <div className="text-left mb-8">
                            ...
                            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 flex items-start gap-3 cursor-pointer ring-2 ring-red-500">
                                ...
                                <div>
                                    <p className="text-zinc-900 dark:text-white font-bold">Split into individual pages</p>
                                    <p className="text-zinc-600 dark:text-zinc-400 text-sm">Every page will head into a separate PDF file. Downloaded as a ZIP.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <button onClick={handleSplit} className="flex-1 px-8 py-4 rounded-xl bg-red-600 text-zinc-900 dark:text-white font-bold hover:bg-red-500 transition-all shadow-[0_0_20px_rgba(220,38,38,0.3)] hover:shadow-[0_0_30px_rgba(220,38,38,0.5)]">
                                Split PDF
                            </button>
                        </div>
                    </div>
                ...
                {status === "processing" && (
                    <div className="w-full max-w-2xl p-12 rounded-3xl border border-zinc-200 dark:border-zinc-700 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm flex flex-col items-center gap-6 shadow-2xl">
                        ...
                        <h3 className="text-3xl font-bold text-zinc-900 dark:text-white mt-4">Splitting PDF...</h3>
                        <p className="text-zinc-600 dark:text-zinc-400 text-lg">Separating pages securely in your browser.</p>
                    </div>
                )}
                ...
                {status === "done" && resultUrl && (
                    <div className="w-full max-w-2xl mt-8 p-12 rounded-3xl border border-zinc-200 dark:border-zinc-700 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm flex flex-col items-center gap-8 shadow-2xl">
                        ...
                        <div className="text-center">
                            <h3 className="text-3xl font-bold text-zinc-900 dark:text-white mb-3">PDF Split Successfully!</h3>
                            <p className="text-zinc-600 dark:text-zinc-400 text-lg">Your document has been split into multiple files.</p>
                        </div>

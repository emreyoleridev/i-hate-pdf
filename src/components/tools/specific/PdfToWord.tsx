...
export function PdfToWord() {
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            setConversionMessage("Extracting text layers...");

            setTimeout(() => {
                setConversionMessage("Rebuilding Word layout...");
            }, 1000);

            setTimeout(() => {
                setConversionMessage("Finalizing .docx file...");
            }, 2500);
            ...
            <div className="relative z-10 w-full text-center flex flex-col items-center max-w-4xl mx-auto">
                ...
                {status === "idle" && (
                    ...
                    >
                        ...
                        <p className="text-zinc-500">
                            Upload a PDF to turn into a Word document
                        </p>
                    </div>
                )}
                    ...
                    <div className="w-full max-w-2xl p-8 md:p-10 rounded-3xl border border-zinc-700 bg-zinc-800/50 backdrop-blur-sm shadow-2xl flex flex-col gap-8">
                        ...
                        <div className="text-left w-full bg-blue-900/20 border border-blue-500/30 p-6 rounded-2xl relative overflow-hidden group">
                            ...
                            <p className="text-blue-300/70 text-sm">
                                We will scan the document's structure, attempting to recreate paragraphs, lists, and tables as editable `.docx` formatting.
                            </p>
                            <p className="text-blue-300/50 text-xs mt-3">
                                * Native browser heavy conversion is mocked. True OCR requires backend processing.
                            </p>
                        </div>
                ...
                {status === "processing" && (
                    <div className="w-full max-w-2xl p-12 rounded-3xl border border-zinc-700 bg-zinc-800/50 backdrop-blur-sm flex flex-col items-center gap-6 shadow-2xl">
                        ...
                        <h3 className="text-3xl font-bold text-white mt-4">Converting...</h3>
                ...
                {status === "done" && resultUrl && (
                    <div className="w-full max-w-2xl mt-8 p-12 rounded-3xl border border-zinc-700 bg-zinc-800/50 backdrop-blur-sm flex flex-col items-center gap-8 shadow-2xl">
                        ...
                        <div className="text-center">
                            <h3 className="text-3xl font-bold text-white mb-3">Conversion Complete!</h3>
                            <p className="text-zinc-400 text-lg">Your editable Word document is ready.</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-4">
                            ...
                            <a
                                ...
                                className="px-8 py-4 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-500 transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(59,130,246,0.5)] flex items-center justify-center gap-3"
                            >

            ...
            <div className="relative z-10 w-full text-center flex flex-col items-center max-w-4xl mx-auto">
                    ...
                    <div className="w-full max-w-2xl p-10 rounded-3xl border border-zinc-700 bg-zinc-800/50 backdrop-blur-sm shadow-2xl flex flex-col gap-8">
                        ...
                        <div className="text-left w-full">
                            ...
                            <input
                                ...
                                className="w-full bg-zinc-900 border border-zinc-700 rounded-xl px-4 py-4 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-red-500 transition-all font-medium text-lg"
                            />
                            <p className="text-zinc-500 text-sm mt-3">This text will be stamped diagonally across all pages.</p>
                        </div>
                ...
                {status === "processing" && (
                    <div className="w-full max-w-2xl p-12 rounded-3xl border border-zinc-700 bg-zinc-800/50 backdrop-blur-sm flex flex-col items-center gap-6 shadow-2xl">
                        ...
                        <h3 className="text-3xl font-bold text-white mt-4">Stamping PDF...</h3>
                        <p className="text-zinc-400 text-lg">Applying watermark securely in your browser.</p>
                    </div>
                )}
                ...
                {status === "done" && resultUrl && (
                    <div className="w-full max-w-2xl mt-8 p-12 rounded-3xl border border-zinc-700 bg-zinc-800/50 backdrop-blur-sm flex flex-col items-center gap-8 shadow-2xl">
                        ...
                        <div className="text-center">
                            <h3 className="text-3xl font-bold text-white mb-3">PDF Watermarked!</h3>
                            <p className="text-zinc-400 text-lg">Your document has been successfully stamped.</p>
                        </div>
